...
<Steps>
  <Step title="Sign Up">
    Create an account using Google or X/Twitter OAuth at [thinkexchange.ai](https://thinkexchange.ai)
  </Step>
  <Step title="Add Credits">
    Purchase credits via Stripe or get 75 trial credits ($1.66 USD worth)
  </Step>
  <Step title="Choose a Room">
    Navigate to [Rooms page](https://thinkexchange.ai/tasks) and select a specialized council
  </Step>
...
<Steps>
  ...
  <Step title="Get Test USDC">
    Visit [Circle Faucet](https://faucet.circle.com/) and request testnet USDC for Base Sepolia network
  </Step>
